...
Untrusted_C_Files := Untrusted/main.c Untrusted/ocalls.c Untrusted/nacl_runner.c #Untrusted/caches.c Untrusted/cctimer.c Untrusted/barrier.c Untrusted/cclfsr.c
Untrusted_Include_Paths := -IUntrusted -I$(SGX_SDK)/include -Iinclude -I/usr/local/include 
...
Untrusted_Link_Flags := $(SGX_COMMON_CFLAGS) -L$(SGX_LIBRARY_PATH) -l$(Urts_Library_Name) -lpthread -ldl -L/usr/local/lib -lsodium
