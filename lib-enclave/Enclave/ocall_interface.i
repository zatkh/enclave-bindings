...
# 6 "Enclave/ocall_interface.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stdarg.h" 1 3 4
# 7 "Enclave/ocall_interface.c" 2
...
# 10 "Enclave/ocall_interface.c" 2
# 1 "/opt/intel/sgxsdk/include/sgx_trts.h" 1
# 35 "/opt/intel/sgxsdk/include/sgx_trts.h"
...
# 36 "/opt/intel/sgxsdk/include/sgx_trts.h" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stddef.h" 1 3 4
...
# 37 "/opt/intel/sgxsdk/include/sgx_trts.h" 2
# 1 "/opt/intel/sgxsdk/include/sgx_defs.h" 1
# 38 "/opt/intel/sgxsdk/include/sgx_trts.h" 2
...
# 11 "Enclave/ocall_interface.c" 2
...
# 48 "/opt/intel/sgxsdk/include/sgx_edger8r.h"
...
# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stddef.h" 1 3 4
# 50 "/opt/intel/sgxsdk/include/sgx_edger8r.h" 2
...
# 9 "Enclave/../ocall_types.h"
typedef int SGX_WRAPPER_FILE;
# 10 "Enclave/Enclave_t.h" 2
# 1 "Enclave/../sgx_lib_stdio.h" 1
# 11 "Enclave/Enclave_t.h" 2
...
int ecall_nacl_main(int argc, char** argv);

sgx_status_t get_raws(int* retval, const char* path);
...
sgx_status_t fopen_ocall(FILE** retval, const char* filename, const char* mode);
sgx_status_t fclose_ocall(int* retval, FILE* stream);
sgx_status_t ocall_fprintf(FILE* stream, const char* format);
sgx_status_t ocall_fscanf(FILE* stream, const char* format);
sgx_status_t rewind_ocall(FILE* file);
sgx_status_t ocall_lns(int* retval, FILE* file);
sgx_status_t ocall_readln(char** retval, FILE* file);
sgx_status_t ocall_fprint_string(int* retval, SGX_WRAPPER_FILE stream, const char* s);
sgx_status_t ocall_clock(clock_t* retval);
sgx_status_t ocall_time(time_t* retval, time_t* t);
sgx_status_t ocall_gettimeofday(int* retval, void* tv, int tv_size, void* tz, int tz_size);
sgx_status_t ocall_gettimeofday2(int* retval, void* tv, int tv_size);
...
sgx_status_t create_session_ocall(sgx_status_t* retval, uint32_t* sid, uint8_t* dh_msg1, uint32_t dh_msg1_size, uint32_t timeout);
sgx_status_t exchange_report_ocall(sgx_status_t* retval, uint32_t sid, uint8_t* dh_msg2, uint32_t dh_msg2_size, uint8_t* dh_msg3, uint32_t dh_msg3_size, uint32_t timeout);
sgx_status_t close_session_ocall(sgx_status_t* retval, uint32_t sid, uint32_t timeout);
sgx_status_t invoke_service_ocall(sgx_status_t* retval, uint8_t* pse_message_req, uint32_t pse_message_req_size, uint8_t* pse_message_resp, uint32_t pse_message_resp_size, uint32_t timeout);
# 17 "Enclave/ocall_interface.c" 2
...
# 175 "Enclave/ocall_interface.c" 3 4
__builtin_va_start(
# 175 "Enclave/ocall_interface.c"
valist
# 175 "Enclave/ocall_interface.c" 3 4
,
# 175 "Enclave/ocall_interface.c"
...
# 175 "Enclave/ocall_interface.c"
                     ;
 void* arg = 
# 176 "Enclave/ocall_interface.c" 3 4
            __builtin_va_arg(
# 176 "Enclave/ocall_interface.c"
            valist
# 176 "Enclave/ocall_interface.c" 3 4
            ,
# 176 "Enclave/ocall_interface.c"
...
# 177 "Enclave/ocall_interface.c" 3 4
__builtin_va_end(
# 177 "Enclave/ocall_interface.c"
valist
# 177 "Enclave/ocall_interface.c" 3 4
)
# 177 "Enclave/ocall_interface.c"
...
char* getenv(const char *name){
    char* ret = 
# 262 "Enclave/ocall_interface.c" 3 4
               ((void *)0)
# 262 "Enclave/ocall_interface.c"
                   ;
...
{
    char buf[
# 323 "Enclave/ocall_interface.c" 3 4
            8192
# 323 "Enclave/ocall_interface.c"
                  ] = { '\0' };
    va_list ap;
    
# 325 "Enclave/ocall_interface.c" 3 4
   __builtin_va_start(
# 325 "Enclave/ocall_interface.c"
   ap
# 325 "Enclave/ocall_interface.c" 3 4
   ,
# 325 "Enclave/ocall_interface.c"
...
# 325 "Enclave/ocall_interface.c"
                    ;
    vsnprintf(buf, 
# 326 "Enclave/ocall_interface.c" 3 4
                  8192
# 326 "Enclave/ocall_interface.c"
                        , fmt, ap);
    
# 327 "Enclave/ocall_interface.c" 3 4
   __builtin_va_end(
# 327 "Enclave/ocall_interface.c"
   ap
# 327 "Enclave/ocall_interface.c" 3 4
   )
# 327 "Enclave/ocall_interface.c"
    ...
    return (int)strnlen(buf, 
# 329 "Enclave/ocall_interface.c" 3 4
                            8192 
# 329 "Enclave/ocall_interface.c"
                                   - 1) + 1;
}
